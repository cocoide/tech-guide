...
import SpeakerDeckEmbed from '@/app/@modal/(.)articles/[article_id]/elements/SpeakerDeckEmbed'
import SpeakerDeckLoader from '@/app/@modal/(.)articles/[article_id]/loader/SpeakerDeckLoader'
